...
client.login(token)
  .then(() => {
  console.log(`Bot ${client.user.username} ismi ile giriş yaptı!`); // YouTube: MZR Development
   client.user.setActivity({ name: 'YouTube: @MZRDev', type: ActivityType.Playing })
